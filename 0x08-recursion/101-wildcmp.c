 ...
 *
 * Return: 1 if the stringa can be considered identical
 * otherwise 0
 */
int wildcmp(char *s1, char *s2)
{
	 ...
	 * if we reached the ends of s2, return 1
...
/**
 * bandersnatch - checks recursively for all the paths when the when the
 * characters are equal
 * @s1: first string
 * @s2: second string
 *
 * Return: return vaalue of wildcmp() or of itself
 */
int bandersnatch(char *s1, char *s2)
{
	/**
